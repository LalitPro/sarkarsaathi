// Sarkar Saathi Eligibility Matching and Dependency Engine for React

// 1. Core Scheme Eligibility Matcher
export const isDemographicallyEligible = (userProfile, scheme) => {
...
export const detectMissingDocuments = (userDocsSetOrArray, schemeRequiredDocuments) => {
...
export const getBoostedEligibility = (userProfile, schemesList, userDocuments) => {
  ...
  // Pre-create User Documents Set ONCE
